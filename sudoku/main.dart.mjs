...
class CompiledApp {
  ...
  async instantiate(additionalImports,
    ...
    const dart2wasm = {
      ...
      _1293: (x0,x1) => x0.push(x1),
      _1294: (x0,x1) => x0.push(x1),
      _1295: (module,f) => finalizeWrapper(f, function() { return module.exports._1295(f,arguments.length) }),
      _1296: (module,f) => finalizeWrapper(f, function() { return module.exports._1296(f,arguments.length) }),
      _1297: x0 => x0.call(),
      ...
      _1302: (module,f) => finalizeWrapper(f, function() { return module.exports._1302(f,arguments.length) }),
      _1310: x0 => x0.breakStatus,
      ...
      _1337: x0 => ({createScriptURL: x0}),
      _1338: (x0,x1,x2) => x0.createPolicy(x1,x2),
      _1339: (x0,x1) => x0.createScriptURL(x1),
      _1340: (x0,x1) => x0.appendChild(x1),
      _1341: (x0,x1) => x0.querySelector(x1),
      _1352: () => globalThis.firebase_core.getApps(),
      _1355: x0 => globalThis.firebase_core.getApp(x0),
      _1358: (x0,x1) => x0.getItem(x1),
      _1359: (x0,x1,x2) => x0.setItem(x1,x2),
      _1373: x0 => x0.apiKey,
      _1375: x0 => x0.authDomain,
      _1377: x0 => x0.databaseURL,
      _1379: x0 => x0.projectId,
      _1381: x0 => x0.storageBucket,
      _1383: x0 => x0.messagingSenderId,
      _1385: x0 => x0.measurementId,
      _1387: x0 => x0.appId,
      _1389: x0 => x0.name,
      _1390: x0 => x0.options,
      ...
      _1609: (o, p) => o[p],
      _1610: (o, p, v) => o[p] = v,
      _1625: x0 => x0.trustedTypes,
      _1626: (x0,x1) => { x0.src = x1 },
      _1636: () => new AbortController(),
      _1637: x0 => x0.abort(),
      _1638: (x0,x1,x2,x3,x4,x5) => ({method: x0,headers: x1,body: x2,credentials: x3,redirect: x4,signal: x5}),
      _1639: (x0,x1) => globalThis.fetch(x0,x1),
      _1640: (x0,x1) => x0.get(x1),
      _1641: (module,f) => finalizeWrapper(f, function(x0,x1,x2) { return module.exports._1641(f,arguments.length,x0,x1,x2) }),
      _1642: (x0,x1) => x0.forEach(x1),
      _1643: x0 => x0.getReader(),
      _1644: x0 => x0.cancel(),
      _1645: x0 => x0.read(),
      _1646: (x0,x1) => x0.key(x1),
      _1649: o => o instanceof Array,
      _1654: a => a.pop(),
      _1655: (a, i) => a.splice(i, 1),
      _1657: (a, s, e) => a.slice(s, e),
      _1659: (a, b) => a == b ? 0 : (a > b ? 1 : -1),
      _1660: a => a.length,
      _1662: (a, i) => a[i],
      _1663: (a, i, v) => a[i] = v,
      _1665: o => {
      ...
      _1666: (o, offsetInBytes, lengthInBytes) => {
        var dst = new ArrayBuffer(lengthInBytes);
        new Uint8Array(dst).set(new Uint8Array(o, offsetInBytes, lengthInBytes));
        return new DataView(dst);
      },
      _1668: o => o instanceof Uint8Array,
      _1669: (o, start, length) => new Uint8Array(o.buffer, o.byteOffset + start, length),
      _1670: o => o instanceof Int8Array,
      _1671: (o, start, length) => new Int8Array(o.buffer, o.byteOffset + start, length),
      _1672: o => o instanceof Uint8ClampedArray,
      _1673: (o, start, length) => new Uint8ClampedArray(o.buffer, o.byteOffset + start, length),
      _1674: o => o instanceof Uint16Array,
      _1675: (o, start, length) => new Uint16Array(o.buffer, o.byteOffset + start, length),
      _1676: o => o instanceof Int16Array,
      _1677: (o, start, length) => new Int16Array(o.buffer, o.byteOffset + start, length),
      _1678: o => o instanceof Uint32Array,
      _1679: (o, start, length) => new Uint32Array(o.buffer, o.byteOffset + start, length),
      _1680: o => o instanceof Int32Array,
      _1681: (o, start, length) => new Int32Array(o.buffer, o.byteOffset + start, length),
      _1683: (o, start, length) => new BigInt64Array(o.buffer, o.byteOffset + start, length),
      _1684: o => o instanceof Float32Array,
      _1685: (o, start, length) => new Float32Array(o.buffer, o.byteOffset + start, length),
      _1686: o => o instanceof Float64Array,
      _1687: (o, start, length) => new Float64Array(o.buffer, o.byteOffset + start, length),
      _1688: (t, s) => t.set(s),
      _1690: (o) => new DataView(o.buffer, o.byteOffset, o.byteLength),
      _1692: o => o.buffer,
      _1693: o => o.byteOffset,
      _1694: Function.prototype.call.bind(Object.getOwnPropertyDescriptor(DataView.prototype, 'byteLength').get),
      _1695: (b, o) => new DataView(b, o),
      _1696: (b, o, l) => new DataView(b, o, l),
      _1697: Function.prototype.call.bind(DataView.prototype.getUint8),
      _1698: Function.prototype.call.bind(DataView.prototype.setUint8),
      _1699: Function.prototype.call.bind(DataView.prototype.getInt8),
      _1700: Function.prototype.call.bind(DataView.prototype.setInt8),
      _1701: Function.prototype.call.bind(DataView.prototype.getUint16),
      _1702: Function.prototype.call.bind(DataView.prototype.setUint16),
      _1703: Function.prototype.call.bind(DataView.prototype.getInt16),
      _1704: Function.prototype.call.bind(DataView.prototype.setInt16),
      _1705: Function.prototype.call.bind(DataView.prototype.getUint32),
      _1706: Function.prototype.call.bind(DataView.prototype.setUint32),
      _1707: Function.prototype.call.bind(DataView.prototype.getInt32),
      _1708: Function.prototype.call.bind(DataView.prototype.setInt32),
      _1711: Function.prototype.call.bind(DataView.prototype.getBigInt64),
      _1712: Function.prototype.call.bind(DataView.prototype.setBigInt64),
      _1713: Function.prototype.call.bind(DataView.prototype.getFloat32),
      _1714: Function.prototype.call.bind(DataView.prototype.setFloat32),
      _1715: Function.prototype.call.bind(DataView.prototype.getFloat64),
      _1716: Function.prototype.call.bind(DataView.prototype.setFloat64),
      _1717: Function.prototype.call.bind(Number.prototype.toString),
      _1718: Function.prototype.call.bind(BigInt.prototype.toString),
      _1719: Function.prototype.call.bind(Number.prototype.toString),
      _1720: (d, digits) => d.toFixed(digits),
      _1734: () => globalThis.adsbygoogle,
      _1735: x0 => { globalThis.adsbygoogle = x0 },
      _2103: x0 => x0.dataset,
      _3140: (x0,x1) => { x0.src = x1 },
      _3146: (x0,x1) => { x0.async = x1 },
      _3150: (x0,x1) => { x0.crossOrigin = x1 },
      _3609: () => globalThis.window,
      _3649: x0 => x0.document,
      _3671: x0 => x0.navigator,
      _3933: x0 => x0.trustedTypes,
